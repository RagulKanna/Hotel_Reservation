...
public class CheapandBestHotelforRegular extends HotelReservationMain {
    public static int[] index = new int[3];

    public static void find_best_hotel_for_regular() throws Exception {
    ...
    private static void display_best_hotel() {
        ...
        System.out.println("\nThe cheapest hotel " + hotel + " with rating : " + best_rate + " and total rate : " + min_rate + "$ per day....");
    }
